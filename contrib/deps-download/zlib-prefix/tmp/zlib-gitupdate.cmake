...
execute_process(
  COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git show-ref "v1.2.11"
  WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/zlib"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/workspaces/taos_odbc/contrib/zlib'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/workspaces/taos_odbc/contrib/zlib'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
