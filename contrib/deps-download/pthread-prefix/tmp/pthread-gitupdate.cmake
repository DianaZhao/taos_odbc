...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git show-ref "v3.0.3.1"
  WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v3.0.3.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v3.0.3.1")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
...
execute_process(
  COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/workspaces/taos_odbc/contrib/pthread'."
    ...
    execute_process(
      COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    )
    execute_process(
      COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
      )
      execute_process(
        COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/workspaces/taos_odbc/contrib/pthread'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/pthread"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
