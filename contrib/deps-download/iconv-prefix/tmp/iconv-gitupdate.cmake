...
execute_process(
  COMMAND "C:/App/Git/cmd/git.exe" --git-dir=.git show-ref "v0.0.8"
  WORKING_DIRECTORY "D:/workspaces/taos_odbc/contrib/iconv"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v0.0.8" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v0.0.8")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/workspaces/taos_odbc/contrib/iconv'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/workspaces/taos_odbc/contrib/iconv'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
